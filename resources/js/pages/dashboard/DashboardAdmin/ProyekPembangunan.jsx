...
const ProyekPembangunan = () => {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold text-gray-800 mb-4">Proyek Pembangunan</h1>
      <div className="p-8 flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg">
        ...
        <p className="text-lg text-gray-600">Halaman Proyek Pembangunan sedang dalam pengembangan</p>
