            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Dana Dialokasikan</p>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Dana Belum Dialokasikan</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              <button
                onClick={() => handleTabChange("daftar-proyek")}
                className={`${
              ...
              <button
                onClick={() => handleTabChange("statistik-proyek")}
                className={`${
                  activeTab === "statistik-proyek"
                    ? "border-[#59B997] text-[#59B997]"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                } whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
              >
              ...
              <button
                onClick={() => handleTabChange("project-expenses")}
                className={`${
